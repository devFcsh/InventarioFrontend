        ...
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            <tr className="border-b dark:border-gray-700">
              <td scope="row" className="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">O</td>
              <td className="px-4 py-3">Computadora</td>
              <td className="px-4 py-3">Lenovo</td>
              <td className="px-4 py-3">IdeaPad</td>
              <td className="px-4 py-3">REM3843</td>
              <td className="px-4 py-3  max-w-[12rem] truncate">S2D-S23-434932</td>
              <td className="px-4 py-3">Carlos Romero</td>
              <td className="px-4 py-3">Profesor</td>
              <td className="px-4 py-3">8G</td>
              <td className="px-4 py-3 flex items-center justify-end">
                <button
                  id="apple-imac-27-dropdown-button"
                  data-dropdown-toggle="apple-imac-27-dropdown"
                  className="inline-flex items-center text-sm font-medium hover:bg-gray-100 p-1.5 dark:hover:bg-gray-800 text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100"
                  type="button"
                >
                  <svg
                    className="w-5 h-5"
