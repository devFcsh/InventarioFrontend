...
const Activos = () => {
  ...
  const modelos = useMemo(() => {
    ...
    return Array.from(new Set(equipos
      .filter(equipo => equipo.periferico === selectedPeriferico.name && equipo.marca === selectedMarca.name)
  ...
  const series = useMemo(() => {
    ...
    return Array.from(new Set(equipos
      .filter(equipo => equipo.periferico === selectedPeriferico.name && equipo.marca === selectedMarca.name && equipo.modelo === selectedModelo.name)
  ...
  const inventarios = useMemo(() => {
    if (!selectedPeriferico || !selectedMarca || !selectedModelo || !selectedSerie) return [];
    return Array.from(new Set(equipos
      .filter(equipo => equipo.periferico === selectedPeriferico.name && equipo.marca === selectedMarca.name && equipo.modelo === selectedModelo.name && equipo.serie === selectedSerie.name)
