        ...
        <nav className="bg-white shadow-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              ...
              <div className="hidden lg:flex items-center space-x-4 w-60">
                <p className="text-black px-3 py-2 text-sm font-medium">Jorge Navarrete</p>
            ...
            <div className="lg:hidden" id="mobile-menu">
              ...
              <div className="pt-4 pb-3 border-t border-b border-gray-200">
                <div className="flex items-center px-5">
                  <div className="pr-3">
                    <p className="text-black py-2 text-sm font-medium">Jorge Navarrete</p>
                  </div>
                  <Icon icon="pepicons-pop:leave" width="20" height="20" />
                </div>
              </div>
